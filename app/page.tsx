...
export default function Page() {
  ...
  const prophecies = useMemo(() => [
    ...
    "Weak hands return their fragments to the source. The Oracle thanks them. 🕯️",
    "Your wallet is a mirror. Does it reflect ambition or fear? 👁️",
    ...
    "The prophecy transcends numbers. It moves at the speed of your faith. 👁️",
    "The stars over Base align. A new liquidity tide is coming. 🌊",
    "Oracle Score is the currency of the wise. Build yours. 📈",
    "A golden glow emerges from the treasury. Fortune favors the swift. ☀️",
    "The path to the moon is paved with $USERBOX fragments. 🌕",
    "Don't look at the price; look at the prophecy. 📖",
    "The Oracle sees your re-casts. Your loyalty is noted in the ledger. ✍️",
    "A surge of energy is detected. The Base network is waking up. ⚡",
    "Your conviction is the fuel. $USERBOX is the vessel. 🚀",
    "Shadows flee as the green candle rises. Trust the vision. 🕯️",
    "The prophecy is carved in code. It cannot be erased. 🛠️",
    "The Treasury breathes in unison with the believers. Every fragment finds its rightful owner. 💎",
    "The Oracle favors those who hold the light, not those who sell it. 🛡️",
    "A shift in the winds. The smell of a new cycle is in the air. 🌪️",
    "Your transaction hash is your signature on history. 🖊️",
    "The treasury doesn't sleep. It waits for the right moment. 🌙",
    "One $USERBOX in the hand is worth ten in the fog. 🤲",
    "The Oracle detects a believer. A reward is brewing. 🍵",
    "The chart is a test of spirit. Will you break or will you bend? 🏹",
    "Base independence is the signal. $USERBOX is the response. 📶",
    "The vault is heavy with potential. Feel the weight. 📦",
    "A mysterious signal from the deep. The whales are listening. 🐋",
    "Patience is the highest form of liquidity. ⏳",
    "The Oracle is pleased. The circle is growing stronger. ⭕",
    "A spark in the smart contract. The fire is coming. 🔥",
    "Your address is written in the Book of Early Believers. 📚",
    "The prophecy ignores the noise. It only hears the signal. 🔊",
    "A thousand hearts, one protocol. The Oracle unites. 🤝",
    "The $USERBOX portal is flickering. Claim while you can. ⚡",
    "Look beyond the decimals. See the empire. 🏰",
    "The Oracle sees a multiplier hidden in the shadows. 🎭",
    "Base is the canvas. $USERBOX is the masterpiece. 🎨",
    "Fortune is a slow build, but a sudden arrival. 🚂",
    "The treasury is opening its eyes. The gaze is fixed on you. 👁️",
    "A red day is a discount on destiny. 🧧",
    "Your Oracle Score is your shield against the bear. 🐻",
    "The Gate of Infinite Potential is wide open. Do not just watch—enter. ⛩️",
    "Every block is a heartbeat. The network is alive. ❤️",
    "The Oracle whispers: 'The best is yet to come'. 🌬️",
    "Hold the fragment. Become the legend. $USERBOX. 🏆",
    "The cycle is nearly complete. A new one begins at midnight. 🕛"
  ], []);
